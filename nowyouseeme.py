...
def nifty(event):
    webbrowser.open_new(r"https://in.finance.yahoo.com/echarts?s=%5ENSEI")
def gold(event):
    webbrowser.open_new(r"http://www.24hgold.com/english/interactive_chart.aspx?codecom=GOLD&chgecom=Chgecom&valecom=valecom")
def silver(event):
    webbrowser.open_new(r"http://www.24hgold.com/english/interactive_chart.aspx?codecom=SILVER&chgecom=Chgecom&valecom=valecom")
